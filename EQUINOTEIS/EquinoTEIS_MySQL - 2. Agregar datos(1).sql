...
--------------------------------------------------------------------------------------------
DELETE FROM Participacion        CASCADE CONSTRAINTS PURGE;
DELETE FROM RevisionVeterinaria  CASCADE CONSTRAINTS PURGE;
DELETE FROM Competicion          CASCADE CONSTRAINTS PURGE;
DELETE FROM Caballo              CASCADE CONSTRAINTS PURGE;
DELETE FROM Veterinario          CASCADE CONSTRAINTS PURGE;
DELETE FROM Propietario          CASCADE CONSTRAINTS PURGE;
DELETE FROM Raza                 CASCADE CONSTRAINTS PURGE;
